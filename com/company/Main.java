                   ...
                   String sqlCreateLesson = "INSERT INTO Lessons (ID, Lesson_Name, Course, Teacher)"
                    ...
                    teacherCombo.addItemListener(new ItemListener() {
                        ...
                        public void itemStateChanged(ItemEvent e) {
                            ...
                            try (Connection conn = ConnectionManager.getConnection()) {
                                PreparedStatement preparedStatementLes = conn.prepareStatement("SELECT Lesson_Name FROM Lessons WHERE Teacher = '" + teacherToLesson + "'");
                                ResultSet rs7 = preparedStatementLes.executeQuery();

                                while (rs7.next()) {
                                    String nameL = rs7.getString("Lesson_Name");
                                    String courseL = rs7.getString("Course");
                                    lessonCombo.addItem(nameL);
                                }
                            } catch (SQLException e1) {
                                e1.printStackTrace();
                            }
                    ...
                    addScoreButton.setBounds(780, 450, 200, 50);
                    ...
                    addScoreButton.addActionListener(new ActionListener() {
                        ...
                        public void actionPerformed(ActionEvent e) {
                            ...
                            if (atz == 0) {
                                tableModelRating.addRow(new Object[] {studentsLabel.getText(), teacherCombo.getSelectedItem(), scoreFieldN.getText()});
                            } else {
